...
class Wav2Vec2Model(BaseFairseqModel):
    ...
    def __init__(self, args):
        ...
        # add args
        self.simul_mode = getattr(args, "simul_mode", None)
    ...
    def extract_features(self, source, padding_mask, mask=False, finish_read=True):
        res = self.forward(source, padding_mask, mask=mask, features_only=True, finish_read=finish_read)
        return res
