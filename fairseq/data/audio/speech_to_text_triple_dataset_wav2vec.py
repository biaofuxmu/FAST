...
class SpeechToTextDataset(FairseqDataset):
    ...
    def __init__(
        ...
        self.norm_by_tgt_len = norm_by_tgt_len
    ...
    def collater(self, samples: List[Tuple[int, torch.Tensor, torch.Tensor]]) -> Dict:
        ...
        if self.norm_by_tgt_len:
            normalize_lengths = target_lengths 
        else:
            normalize_lengths = transcription_lengths
        ...
        out = {
            ...
            "net_input": {
                ...
                "target_lengths": normalize_lengths,
            },
            "target": target,
