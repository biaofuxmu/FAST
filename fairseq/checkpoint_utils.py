...
def load_pretrained_component_from_model(
    ...
    if not PathManager.exists(checkpoint):
        logging.error("Model file not found: {}".format(checkpoint))
    else:
    ...
    mismatch_keys = []
    if not strict:
        def check_mismatch(load_state_dict, modules, prefix=''):
            ...
            for name, child in modules._modules.items():
                check_mismatch(load_state_dict, child, name + prefix + ".")

        check_mismatch(component_state_dict, component)
